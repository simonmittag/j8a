...
security and operations needs of a devops audience in mind. 
...
* Efficient. Frees upstream connections immediately on downstream disconnects and timeouts. No dangling or leaking network resources.
