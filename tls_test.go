...
//this test uses a self-signed root CA but supplies it as part of the chain. should validate. this is
//the recommended way to configure the server with a self-signed CA.
func TestCertChainC_I_RValid(t *testing.T) {
